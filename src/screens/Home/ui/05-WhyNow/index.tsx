...
export const WhyNow: React.FC = () => {
  return (
    <Section
      ...
      // whynowbg={{ showOnEnter: true, hideOnLeave: true }}
    >
      <div className="pointer-events-none absolute left-1/2 bottom-0 -translate-x-1/2 w-[10%] h-40 backdrop-blur-xs" />
        ...
        <div className="max-w-189 w-full flex flex-col items-center">
          ...
          >
            With capital for early-stage B2B SaaS in New York increasingly
            scarce due to investor flight to later-stage and consumer deals, the
            current environment presents a rare opportunity to back resilient,
          ...
          <Text
            ...
            animation={{ delay: 0.5 }}
          >
            As macroeconomic uncertainty persists into 2025, disciplined
            investors willing to underwrite early-stage risk are uniquely
            positioned to capture outsized returns as the next wave of
            enterprise innovation emerges from this funding gap.
          </Text>

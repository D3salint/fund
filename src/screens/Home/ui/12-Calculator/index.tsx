    ...
    <Section className="py-12 max-md:py-6 px-4 flex flex-col justify-center">
      <div className="mx-auto max-w-380 w-full">
        ...
        <Motion
          delay={0.4}
          stagger={0.15}
          animationElement=".calc-aos"
          initialState="[&_.calc-aos]:translate-y-8 [&_.calc-aos]:opacity-0 [&_.calc-aos]:blur-md"
        >
          <ContentCard
            className={clsx(
              ".calc-aos before:backdrop-blur-3xl rounded-[3.75rem] mt-10 p-7.5 py-6.25 grid grid-cols-2 gap-6 max-sm:mt-5",
              "max-lg:grid-cols-1 max-sm:py-4.5 max-sm:px-4 max-sm:rounded-2xl"
            )}
          >
            {/* Left */}
            <div className="calc-aos">
              <h3
                className={clsx(

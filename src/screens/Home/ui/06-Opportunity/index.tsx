...
export const Opportunity: React.FC = () => {
  return (
    <Section glare={{ showOnEnter: true, hideOnLeave: true }}
    className="px-14 py-10 flex flex-col max-md:px-4 bg-[url(/images/opportunity-bg.webp)] bg-cover bg-top-left max-sm:bg-position-[-140%_top] relative">

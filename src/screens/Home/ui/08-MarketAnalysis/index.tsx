...
export const MarketAnalysis: React.FC = () => {
  return (
    <Section className="pt-24 pb-10 max-xxxl:pt-20 max-sm:pt-8  bg-cover bg-top-right max-sm:bg-position-[-70%_top] relative">
      ...
      <div className="max-w-400 px-10 mx-auto w-full max-lg:px-6 max-md:px-4">
        ...
        <div className="relative mt-16.5 grid grid-cols-[auto_24.1rem] gap-11 max-xxl:gap-4 max-xl:grid-cols-1 max-lg:mt-7">
          <Motion
            delay={0.35}
            initialState="scale-10 opacity-0"
          ...
          >
            ...
            <MarketGapAnalysisChart className="grow mt-5 min-h-40 aspect-[1/0.42] max-sm:aspect-[1/0.49] z-50" />
